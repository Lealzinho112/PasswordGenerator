...
#These are simply some simple classes to manage the information#
class Node:
...
#The PasswordCreator itself is very basic. You can create a random password and change it afterwards#
